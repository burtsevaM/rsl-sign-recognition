...
2. Зафиксировать milestone, epic, зависимости и acceptance criteria.
3. Создать отдельную ветку по конвенции выше.
4. Выполнить изменение в рамках согласованного scope.
5. Приложить результаты проверки и открыть PR по шаблону.
